...
async function createChat() {
    try {
        const response = await fetch(`${host}/api/message/create-chat`, {
            method: "POST",
            headers: {
...
async function removeChat() {
    try {
        const response = await fetch(`${host}/api/message/remove-chat`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function startChatSession(friendID) {
    try {
        const response  = await fetch(`${host}/api/message/start-chat-session`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function fetchMessages() {
    try {
        const response = await fetch(`${host}/api/message/fetch-messages`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function getSingleMessage(srcID, messageID) {
    try {
        const response = await fetch(`${host}/api/message/get-single-message`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function sendMessages(friendID, type, content, replyTo) {
    try {
        const response = await fetch(`${host}/api/message/send-messages`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function updateTimestampMessage() {
    try {
        const response = await fetch(`${host}/api/message/update-seen-message`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function loadMoreMessages() {
    try {
        const response = await fetch(`${host}/api/message/load-more-messages`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function downloadFile(filePath) {
    try {
        const response = await fetch(`${host}/api/message/download-file`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function toggleNotification() {
    try {
        const response = await fetch(`${host}/api/message/toggle-notification`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
